...
<template>
  <div class="detail">
    ...
    <div class="left">
      <img
        class="propertyImg"
        :src="props.property?.propertyImg"
    ...
    <div>
      ...
      <div class="option1">
        ...
        <div>
          <i class="fa-solid fa-ruler-combined"></i>&ensp;{{
            parseFloat(props.property?.supplyArea.toFixed(2))
          }}m²
        </div>
        <div>
          <i class="fa-solid fa-won-sign"></i>&ensp;{{
            props.property?.managementFee.toLocaleString()
          }}
        </div>
      ...
      <div class="description">
        ...
        <p>
          - 구축 오피스텔(아파트) 이지만 레지던스 호텔로 계속 운영되던 곳이라 관리가 잘 되어있음
        </p>
        <p>- 신축대비 아주 넓은 실내 면적, 베란다 있음</p>
        <p>
          - 화장실까지 올수리, 붙박이 가구 및 LG 오브제 워시타워, 인덕션, 에어컨 등 새가전 신혼부부
          첫 입주로 완비되어 있음
        </p>
        <p>- 지하에 헬스장, 사우나가 있어서 아주 편리</p>
        <p>- 강남역 신논현 방면의 번화가와 다르게 삼성타운 뒷편 주거단지 쪽이라 조용함</p>
        <p>
          - 올리브영, 스타벅스, 맥도날드, 베스킨, 던킨 그리고 많은 약국과 병원들로 생활이 편리함
        </p>
        <p></p>
