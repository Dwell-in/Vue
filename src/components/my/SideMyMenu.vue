...
const handelSelectMenu = (e, menu) => {
  selected.value = menu
}
const selectChat = (e, menu) => {
  handelSelectMenu(e, menu)
...
<template>
  <div class="my-main">
    <div class="menu" @click="(e) => selectChat(e, 'Chat')" :class="{selected: selected == 'Chat'}">
    ...
    <div class="menu" @click="(e) => handelSelectMenu(e, 'Favorite')" :class="{selected: selected == 'Favorite'}">
    ...
    <div class="menu" @click="(e) => handelSelectMenu(e, 'View')" :class="{selected: selected == 'View'}">
    ...
    <div class="menu" @click="(e) => handelSelectMenu(e, '?')" :class="{selected: selected == '?'}"></div>
    <div class="menu" @click="(e) => handelSelectMenu(e, '?')" :class="{selected: selected == '?'}"></div>
  </div>
</template>
